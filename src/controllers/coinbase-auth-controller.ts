...
export const getCoinbaseLogin: RequestHandler = async (req, res, next) => {
  res.redirect(`http://www.coinbase.com/oauth/authorize?response_type=code&client_id=920061065859143b276c9118f33e3cd48bde5ededaa8e2cfc0ef8ac5d7fb51db&redirect_uri=http://localhost:3000/coinbase/redirect&scope=wallet:accounts:read,wallet:sells:read,wallet:buys:read`);
};
